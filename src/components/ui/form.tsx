...
>(({ children, ...props }, ref) => {
  ...
  // Check if we have exactly one valid React element child
  const childArray = React.Children.toArray(children);
  const hasOnlyOneElement =
  ...
  // Fallback: wrap the children without using Slot
  ...
  if (firstChild && React.isValidElement(firstChild)) {
    const childProps =
      typeof firstChild.props === "object" && firstChild.props
        ? firstChild.props
        : {};
    return React.cloneElement(firstChild as any, {
      ref,
      id: formItemId,
