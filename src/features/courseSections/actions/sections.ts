...
import { SectionSchema, sectionSchema } from "../schemas/sections";
import {
...
export async function updateSection(id: string, unsafeData: SectionSchema) {
  const { success, data } = sectionSchema.safeParse(unsafeData);
